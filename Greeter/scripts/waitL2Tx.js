...
const walletMnemonic = Wallet.fromMnemonic(walletPrivateKey)
const l1Wallet = new Wallet(walletMnemonic.privateKey, l1Provider)
const l2Wallet = new Wallet(walletMnemonic.privateKey, l2Provider)
